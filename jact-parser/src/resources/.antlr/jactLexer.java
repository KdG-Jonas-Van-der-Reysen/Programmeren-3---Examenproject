...
public class JactLexer extends Lexer {
	...
	public static final int
		...
		T__17=18, ID=19, INT=20, FLOAT=21, BOOL=22, STRING=23, VOID=24;
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "';'", "'print'", "'('", "')'", "' '", "':'", "' = '", "'const'", 
			"'let'", "'var'", "'function'", "') {'", "'}'", "','", "'int'", "'float'", 
			"'bool'", "'string'", null, null, null, null, null, "'void'"
		};
	}
	...
	public JactLexer(CharStream input) {
		super(input);
